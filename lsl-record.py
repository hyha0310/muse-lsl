...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 13 14:13:03 2017
...
from timecorr import ts_linear
...
#Correct the timestamps using my function ts_linear
ts_correct = True
...
if ts_correct:
    ...
    timestamps = ts_linear(timestamps)
...
#My edit_2: Saving markers separately
markers_pd = pd.DataFrame(data = np.array(markers))
markers_pd.to_csv("markers_%s.csv" % strftime("%Y-%m-%d-%H.%M.%S", gmtime()))
